    ...
    */
    ...
    CarItemComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getManufacturers()
            .subscribe(function (manufacturers) { _this.ManufacturersObject = manufacturers; });
        this.getCars(this.toSearch, 0);
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getCImages = function (toSearch) {
        return this.http.get("api/cimages", {
            params: toSearch /* {
              model: model ,
              color: color,
              userID: userID
    ...
    DataService.prototype.updateCar = function (carID, formData) {
        ...
        return this.http.put("api/car/" + carID, formData, { headers: headers });
        //.map( res => res.json());
    };
...
module.exports = __webpack_require__(/*! C:\Users\ammostafa\Desktop\motorat\motora-mysql\motorat-frontend\src\main.ts */"./src/main.ts");
